                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="container text-center p-4"><h5 class="card-title">Add new customer <i class="bi bi-plus"></i></h5></div>


                            <div class="container p-5">
                                <form method="post">
                                    <div class="form-floating mb-4">
                                     <input type="text" name="cname" class="form-control" id="floatingName" placeholder=" " >
                                     <label for="floatingName">Name</label>
                                    </div>
            
                                    <div class="form-floating mb-4">
                                      <input type="text" name="cbusiness" class="form-control" id="floatingName" placeholder=" ">
                                      <label for="floatingName">Business name</label>
                                    </div>
            
                                    <div class="form-floating mb-4">
                                      <input type="text" name="caddress" class="form-control" id="floatingName" placeholder=" ">
                                      <label for="floatingName">Address</label>
                                    </div>
            
                                    <div class="form-floating mb-4">
                                      <input type="email" name="cemail" class="form-control" id="floatingName" placeholder=" ">
